...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider<HomeScreenBloc>.value(
        value: _bloc,
        child: BlocBuilder<HomeScreenBloc, HomeScreenState>(
          bloc: _bloc,
          builder: (context, state) => extended.NestedScrollView(
              ...
              SliverOverlapAbsorber(
                ...
                sliver: SliverAppBar(
                  ...
                  title: SmoothPageIndicator(
                    ...
                    effect: WormEffect(
                      dotColor: Theme.of(context).iconTheme.color.withAlpha(50),
            ...
            body: PageView.builder(
              ...
              physics: BouncingScrollPhysics(),
              itemCount: max(1,
                  (state.locationEnabled ? 1 : 0) + state.savedPlaces.length),
